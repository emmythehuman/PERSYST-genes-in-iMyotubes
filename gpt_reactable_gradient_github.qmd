...
author: "Emmylou Cortez Nicolas-Martinez"
...
## **Expression Levels of all Genes in iMyotubes**

This table shows averaged TPM values across different days of iMyotube transdifferentiation of four biological replicates (MC2936, MC3652, FC45. FC46).
...
## **Expression Levels of PERSYST Genes in iMyotubes**
...
# Load the gene expression data
dge3 <- read_csv("iMyotubes_Average_Days_PERSYST.csv")
